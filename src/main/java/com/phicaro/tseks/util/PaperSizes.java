...
public class PaperSizes {
    ...
    Map<String, Paper> paperDefinitions = new HashMap<String, Paper>();
    ...
    public Paper getSelectedPaper(final String id) {
    ...
    public synchronized void setPrintService(final PrintService p) {
        this.printService = p;
        paperDefinitions = new HashMap<String, Paper>();
    ...
    private void checkAndAddSize(final MediaSizeName name) {
        ...
        paper.setImageableArea(values[0] * mmToSubInch, values[1] * mmToSubInch, values[2] * mmToSubInch, values[3] * mmToSubInch);
